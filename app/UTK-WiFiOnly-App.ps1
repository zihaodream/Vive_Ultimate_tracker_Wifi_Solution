param(
    [ValidateSet("StartKeepalive", "ApplyWifi", "Start", "Stop", "Restart", "Status", "ConfigureOnly")]
...
function Start-Keepalive {
    ...
    $process = Start-Process -FilePath $ps -ArgumentList $argsList -RedirectStandardOutput $stdout -RedirectStandardError $stderr -WindowStyle Hidden -PassThru
    $state = [ordered]@{
        pid = $process.Id
